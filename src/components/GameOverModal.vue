    ...
    <div class="bg-[#f1e8e0] py-8 px-15 w-4/5 mx-auto rounded-2xl">
      ...
      <div v-else="showForm" class="flex justify-center mt-8 text-2xl">
        <button v-if="bestScore" @click="handleSubmit"
          class="bg-amber-500 border-transparent font-medium w-[362px] mr-4 hover:-translate-y-0.5 cursor-pointer rounded px-6 py-2 text-base">
          Submit</button>
        <button @click="showForm = false"
          class=" bg-stone-800 border-transparent font-medium w-[362px] hover:-translate-y-0.5 cursor-pointer rounded px-6 py-2 text-base">
          Cancel</button>
      </div>
    </div>
