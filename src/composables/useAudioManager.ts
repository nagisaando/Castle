...
export function useAudioManager(): AudioManager {
  ...
  const moveSounds = createSoundPool('/sound/zapsplat_cartoon_swoosh_swipe_whoosh_snatch_001_111185.mp3', 0.2)
